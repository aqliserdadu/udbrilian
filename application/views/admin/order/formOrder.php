<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Pesanan</li>
        <li class="active">Form Pesanan</li>
      </ol>
</section>
							  ...
							  <div id="info"></div>
								...
								<div class="col-md-12" style="margin-top:8px">
									<div class="input-group">
										 ...
										 <input type="text" name="invoice" id="invoice" required class="form-control" placeholder="No Invoice" value="<?php echo $invoice;?>" readonly>
									</div>
			...
			<div class="box box-info">
				...
				<div class="box-body">
					...
					<div class="col-md-12">	
							...
							<form action="<?php echo base_url('adminDigital/Order/simpanOrder');?>" method="POST" id="saveOrder">
								...
								<div class="modal-footer">
									<input type="submit" value="Simpan" name="simpan" class="btn btn-success text-right" onclick="return confirm('Apakah anda ingin melakukan transaksi?')">
								</div>
							</form>
				</div>
			</div>
	...
	$.ajax({
				...
				success	: function(data){	
							if(data.status == true)
							{
								...
								$("#listOrder").load("<?php echo base_url('adminDigital/Order/listOrder/');?>" + data.inv);
