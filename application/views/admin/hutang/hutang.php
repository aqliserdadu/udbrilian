...
function hapus(id){
		...
		if(confirm('Apa Anda Yakin Ingin Menghapus? Ini akan berdampak pada Daftar Piutang!')){
			...
			$.ajax({
								...
								success	: function(data){	
											if(data.status == true){	
												...
												$("#content").load("<?php echo base_url('admin/Hutang/listHutang');?>");
											}
