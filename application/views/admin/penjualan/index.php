			...
			<div class="box box-info">
				<div class="box-body">
					<div class="row">
						...
						<div class="col-md-12" id="listPenjualan" style="margin-top:15px">
...
<script type="text/javascript">
	...
	function detail(nota) {
		...
		$("#formCari").hide();
		$("#listPenjualan").load("<?php echo base_url('admin/Penjualan/detailPenjualan/'); ?>" + nota);
	}
	...
	function hapus(nota) {
		...
		if (confirm('Apa Ingin Menghapus? Data Stok Akan Terhapus Juga')) {
			...
			$.ajax({
				...
				url: '<?php echo base_url('admin/Penjualan/hapusPenjualan'); ?>',
				type: "POST",
				data: {
					id: nota
				},
				...
				success: function(data) {
					if (data.status == true) {
						...
						$("#listPenjualan").load("<?php echo base_url('admin/Penjualan/listPenjualan'); ?>");
					}
