				...
				<div class="col-md-12">
					<form id="formPenjualan" action="#" method="POST">	
						<div style="padding:5px; text-align:center; background-color:#7FFFD4; color:black; border:1px solid #fff">
							<input type="text" name="so" id="so" value="<?php echo $row->idheader; ?>" readonly class="form-control" style="text-align:center">
						</div>
							...
							<div class="col-md-4"> 
								<div class="input-group">
									...
									<input type="text" name="date" readonly id="date" required class="form-control" style="color:black;" value="<?php echo $row->date;?>">
								</div>
							</div>
							...
							<div class="col-md-4">
								<div class="input-group">
									...
									<input type="text" name="namapelanggan" id="namapelanggan" value="<?php echo $row->namapelanggan;?>" class="form-control" style="color:black;" placeholder="Custamer"> 
							...
							<div class="col-md-10">
								...
								<table id="table" class="table table-striped">
                                        ...
                                        <?php foreach($data as $tp){?>
                                            ...
                                            <tr>
												<td><?php echo $no++;?></td>
												<td><input type="text" name="idbarang[]" style="width:80px" value="<?php echo $tp->idbarang;?>" id="idbarang<?php echo $angka;?>" onkeyup="getIdBarang('<?php echo $angka;?>')" placeholder="ID Barang"></td>
												<td><input type="text" name="t[]" style="width:50px" value="<?php echo $tp->t;?>" id="t<?php echo $angka;?>" onkeyup="hitungT('<?php echo $angka;?>')"></td>
